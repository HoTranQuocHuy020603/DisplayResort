...
<head>
<meta charset="UTF-8">
<title>Page of Edit Employee</title>
			...
			<div class="row2">
			    <div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="text" name="id" id="id" value="${employeeEdit.id}"
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="text" name="firstname" id="firstname" value="${employeeEdit.firstname}"
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="text" name="lastname" id="lastname" value="${employeeEdit.lastname}"
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="email" name="email"  id="email"  value="${employeeEdit.email}"
					...
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="text" class="form-control" name="phonenumber" id="phonenumber"
								value="${employeeEdit.phonenumber}" required="required" placeholder="Enter Phone Number">
						</div>
					</div>
				</div>
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-4 male">
							<input type="radio" name="gender" id="gender" value="1"${employeeEdit.gender == 1?"checked":"" }
								required="required">Male
						</div>

						<div class="col-xs-4 female">
							<input type="radio" name="gender" id="gender" value="0"${employeeEdit.gender == 0?"checked":"" }
						...
						<div class="col-xs-4 admin">
							<input type="radio" name="position" id="position" value="1"${employeeEdit.position == 1?"checked":"" }
								required="required">Admin
						</div>

						<div class="col-xs-4 employee">
							<input type="radio" name="position" id="position" value="0"${employeeEdit.position == 0?"checked":"" }
								required="required">Employee
						</div>
