...
<head>
<meta charset="UTF-8">
<title>Page of Edit Account</title>
			...
			<div class="row2 ">
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="text" name="id" id="id" value="${accountEdit.id}"
								placeholder="Enter ID" class="form-control" readonly>
						</div>
					</div>
				</div>
				<!--- For UserName---->
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="text" name="username" id="fname" value="${accountEdit.username}"
								placeholder="Enter User Name" class="form-control" readonly>
						</div>
					</div>
				</div>
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-8">
							<input type="password" name="password" id="password" value="${accountEdit.password}"
				...
				<div class="col-sm-12">
					<div class="row2">
						...
						<div class="col-xs-4 Yes">
							<input type="radio" name="isAdmin" id="isAdmin" value="1"
										${accountEdit.isAdmin == true?"checked":"" } >Yes
						</div>

						<div class="col-xs-4 No">
							<input type="radio" name="isAdmin" id="isAdmin" value="0"
										${accountEdit.isAdmin == false?"checked":"" } >No
						</div>
					...
					<div class="row2">
						...
						<div class="col-xs-4 Yes">
							<input type="radio" name="isEmployee" id="isEmployee"value="1"
									${accountEdit.isEmployee == true?"checked":"" } >Yes
						</div>

						<div class="col-xs-4 No">
							<input type="radio" name="isEmployee" id="isEmployee" value="0"
									${accountEdit.isEmployee == false?"checked":"" } >No
						</div>
